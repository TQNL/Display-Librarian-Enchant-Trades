...
## no data at all
execute unless data entity @s data.dlet_enchant_data run return run function dlet:main2

## outdated data
execute if score @s dlet_show_trade_counter < @s dlet_trade_counter run function dlet:main2
